  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="vrToolsApp.country.home.createOrEditLabel">Create or edit a Country</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : countryEntity} onSubmit={saveEntity}>
              ...
              <AvGroup>
                <Label id="populationCountLabel" for="country-populationCount">
                  Population Count
                </Label>
                <AvField
                  id="country-populationCount"
                  type="string"

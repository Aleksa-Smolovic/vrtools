  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="vrToolsApp.city.home.createOrEditLabel">Create or edit a City</h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <AvForm model={isNew ? {} : cityEntity} onSubmit={saveEntity}>
              ...
              <AvGroup check>
                <Label id="isCapitalLabel">
                  <AvInput id="city-isCapital" type="checkbox" className="form-check-input" name="isCapital" />
                  Is Capital
                </Label>
              </AvGroup>
              <AvGroup>
